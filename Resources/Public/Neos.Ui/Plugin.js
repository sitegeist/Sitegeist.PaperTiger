...
var Preview = function Preview(props) {
    ...
    return React.createElement(IconCard, { icon: "envelope", title: props.value.label, subTitle: "" + props.value.value });
};
...
var Form = function Form(props) {
    ...
    return React.createElement(Layout.Stack, null, React.createElement(Layout.Columns, { columns: 2 }, React.createElement(Field, { name: "label", label: "Label", editor: "Neos.Neos/Inspector/Editors/TextFieldEditor" }), React.createElement(Field, { name: "value", label: "Value", editor: "Neos.Neos/Inspector/Editors/TextFieldEditor" })));
};
exports.Form = Form;
...
exports.Option = __importStar(__webpack_require__(/*! ./Option */ "./lib/Option/Option.js"));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Option = void 0;
var Option_1 = __webpack_require__(/*! ./Option */ "./lib/Option/index.js");
Object.defineProperty(exports, "Option", { enumerable: true, get: function get() {
...
(0, _neosUiExtensibility2.default)('@sitegeist/papertiger-editors', {}, function (globalRegistry) {
	...
	editorsRegistry.set('Sitegeist\\PaperTiger\\Domain\\OptionSpecification', _lib.Option);
});
